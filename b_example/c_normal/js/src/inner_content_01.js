...
*/
 ...
 var shop  = $('.shop');
 var color = ['#ff0', '#cca', '#cca', '#f06', '#f7f', '#afa'];
 ...
 var productList=[
 {color:'#ff0', text:'제품1 에대한 각각 설명하기!!!',link:'http://naver.com'},
 {color:'#cca', text:'제품2 에대한 각각 설명하기!!!',link:'http://daum.com'},
 {color:'#cca', text:'제품3 에대한 각각 설명하기!!!',link:'http://naver.com'},
 {color:'#f06', text:'제품4 에대한 각각 설명하기!!!',link:'http://naver.com'},
 {color:'#f7f', text:'제품5 에대한 각각 설명하기!!!',link:'http://naver.com'},
